...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of simple_sgdma_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins simple_sgdma_0/axi_lite_reg]
	connect_bd_net [get_bd_pins simple_sgdma_0/axi_lite_reg_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins simple_sgdma_0/axi_lite_reg_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock & reset of simple_sgdma_0 streaming interfaces..
	connect_bd_net [get_bd_pins simple_sgdma_0/axis_sts_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins simple_sgdma_0/axis_sts_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins simple_sgdma_0/axis_cmd_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins simple_sgdma_0/axis_cmd_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to simple_sgdma_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/simple_sgdma_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_simple_sgdma_0_axi_lite_reg_* ]]
	puts $fp "set axi_lite_reg_addr ${offset}"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/simple_sgdma_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "simple_sgdma_v1_0_hw_${i}"
