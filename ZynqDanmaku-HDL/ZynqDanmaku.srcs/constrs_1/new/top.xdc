...
set_output_delay -clock clk_out2_clk_wiz_0 -min -add_delay -1.300 [get_ports {O1_D[*]}]
set_output_delay -clock clk_out2_clk_wiz_0 -max -add_delay 1.800 [get_ports {O1_D[*]}]
set_output_delay -clock clk_out2_clk_wiz_0 -min -add_delay -1.300 [get_ports DEA]
set_output_delay -clock clk_out2_clk_wiz_0 -max -add_delay 1.800 [get_ports DEA]
set_output_delay -clock clk_out2_clk_wiz_0 -min -add_delay -1.300 [get_ports HSA]
set_output_delay -clock clk_out2_clk_wiz_0 -max -add_delay 1.800 [get_ports HSA]
set_output_delay -clock clk_out2_clk_wiz_0 -min -add_delay -1.300 [get_ports O1_VS]
set_output_delay -clock clk_out2_clk_wiz_0 -max -add_delay 1.800 [get_ports O1_VS]

set_output_delay -clock clk_out2_clk_wiz_0 -min -add_delay -1.300 [get_ports {O2_D[*]}]
set_output_delay -clock clk_out2_clk_wiz_0 -max -add_delay 1.800 [get_ports {O2_D[*]}]
set_output_delay -clock clk_out2_clk_wiz_0 -min -add_delay -1.300 [get_ports DEB]
set_output_delay -clock clk_out2_clk_wiz_0 -max -add_delay 1.800 [get_ports DEB]
set_output_delay -clock clk_out2_clk_wiz_0 -min -add_delay -1.300 [get_ports HSB]
set_output_delay -clock clk_out2_clk_wiz_0 -max -add_delay 1.800 [get_ports HSB]
set_output_delay -clock clk_out2_clk_wiz_0 -min -add_delay -1.300 [get_ports O2_VS]
set_output_delay -clock clk_out2_clk_wiz_0 -max -add_delay 1.800 [get_ports O2_VS]
