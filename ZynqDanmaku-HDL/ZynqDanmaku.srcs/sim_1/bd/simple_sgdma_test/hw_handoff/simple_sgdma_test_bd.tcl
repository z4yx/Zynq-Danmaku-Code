...
################################################################
# This is a generated script based on design: simple_sgdma_test
#
...
# source simple_sgdma_test_script.tcl
...
set design_name simple_sgdma_test
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.DATA_READ_SHARE {100} \
   CONFIG.DATA_SIZE_AVG {32} \
   CONFIG.DATA_SIZE_MAX {64} \
   CONFIG.DATA_SIZE_MIN {8} \
   ...
   CONFIG.MASTER_HIGH_ADDRESS {0x00000FFF} \
  ...
  connect_bd_intf_net -intf_net axi_traffic_gen_0_M_AXI [get_bd_intf_pins axi_traffic_gen_0/M_AXI] [get_bd_intf_pins smartconnect_0/S01_AXI]
  ...
  connect_bd_intf_net -intf_net simple_sgdma_0_axis_cmd [get_bd_intf_pins axi_datamover_0/S_AXIS_MM2S_CMD] [get_bd_intf_pins simple_sgdma_0/axis_cmd]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axi_datamover_0/m_axi_mm2s_aresetn] [get_bd_pins axi_traffic_gen_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_datamover_0/m_axi_mm2s_aclk] [get_bd_pins axi_traffic_gen_0/s_axi_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins simple_sgdma_0/datamover_axi_clk] [get_bd_pins smartconnect_0/aclk]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_traffic_gen_0/Data] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x00010000 -offset 0x40500000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs simple_sgdma_0/axi_lite_reg/axi_lite_reg_reg] SEG_simple_sgdma_0_axi_lite_reg_reg
